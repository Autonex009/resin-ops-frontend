...
import { PolymerFlowDiagram } from "@/components/polymer-flow-diagram";
...
//
// Commented out in favor of the live R1 -> H1 -> F1 mass-balance diagram
// below (digitized from the client's polymer-production flow sheet) for
// the client walkthrough. Uncomment to restore the esterification/blending
// monitor cards.
//
...
export default function MachinesPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-lg font-semibold">Machines Monitors</h1>
        <p className="text-sm text-muted-foreground">
          Live mass balance across the polymer reactor and vacuum filtration line.
        </p>
      </div>
